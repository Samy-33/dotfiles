...
modules = {["core.defaults"] = {}, ["core.keybinds"] = {config = {hook = _4_}}, ["core.dirman"] = {config = {workspaces = {oliv = "~/neorg/oliv", personal = "~/neorg/personal"}, index = "index.norg"}}, ["core.concealer"] = {}}
