...
telescope.setup({defaults = {mappings = {i = {["<C-q>"] = (actions.smart_send_to_qflist + actions.open_qflist), ["<C-d>"] = false, ["<C-u>"] = false}}}, extensions = {live_grep_args = {auto_quoting = true, mappings = {i = {["<C-k>"] = lga_actions.quote_prompt(), ["<C-i>"] = lga_actions.quote_prompt({postfix = " --iglob "}), ["<C-space>"] = actions.to_fuzzy_refine}}}}})
